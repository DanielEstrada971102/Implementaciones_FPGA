...
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { led_tw }]; #IO_L23P_T3_35 Sch=LED3
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { detector1 }]; #IO_L17P_T2_34 Sch=JA1_P
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { detector2 }]; #IO_L7P_T1_34 Sch=JA2_P
...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { detector3 }]; #IO_L8P_T1_34 Sch=JB1_P
...
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { tw_out }]; #IO_L1P_T0_34 Sch=JB2_P
