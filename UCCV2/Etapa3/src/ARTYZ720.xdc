...
## Switches
#set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { freq_select_0[0] }]; #IO_L7N_T1_AD2N_35 Sch=SW0
#set_property -dict { PACKAGE_PIN M19    IOSTANDARD LVCMOS33 } [get_ports { freq_select_0[1] }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
## LEDs
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { led_1}]; #IO_L6N_T0_VREF_34 Sch=LED0
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { led_2}]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { led_3 }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { led_wt  }]; #IO_L23P_T3_35 Sch=LED3
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports {tw_out }]; #IO_L17P_T2_34 Sch=JA1_P
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { led_entrada3 }]; #IO_L17N_T2_34 Sch=JA1_N
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { detector1 }]; #IO_L7P_T1_34 Sch=JA2_P
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets detector1_IBUF]
...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { detector2 }]; #IO_L8P_T1_34 Sch=JB1_P
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets detector2_IBUF]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { jb_n[2] }]; #IO_L1N_T0_34 Sch=JB2_N
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { detector3 }]; #IO_L1P_T0_34 Sch=JB2_P
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets detector3_IBUF]
