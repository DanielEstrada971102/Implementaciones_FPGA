...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/comblock/comblock.runs/Comblock_desing_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comblock_desing_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comblock_desing_auto_pc_1.tcl
