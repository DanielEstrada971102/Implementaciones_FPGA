...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/prueba_comblock/prueba_comblock.runs/prueba_comblocl_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_comblocl_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_comblocl_xbar_0.tcl
