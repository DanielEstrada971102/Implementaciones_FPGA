...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/prueba_comblock/prueba_comblock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_comblocl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_comblocl_wrapper.tcl
