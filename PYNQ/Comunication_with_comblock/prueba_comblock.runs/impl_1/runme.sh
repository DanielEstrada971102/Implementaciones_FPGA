...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/prueba_comblock/prueba_comblock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_comblocl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prueba_comblocl_wrapper.tcl -notrace
