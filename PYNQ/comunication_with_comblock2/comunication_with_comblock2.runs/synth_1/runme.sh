...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/comunication_with_comblock2/comunication_with_comblock2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_comblock2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_comblock2_wrapper.tcl
