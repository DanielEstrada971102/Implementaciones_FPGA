...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/comunication_with_comblock2/comunication_with_comblock2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_comblock2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prueba_comblock2_wrapper.tcl -notrace
