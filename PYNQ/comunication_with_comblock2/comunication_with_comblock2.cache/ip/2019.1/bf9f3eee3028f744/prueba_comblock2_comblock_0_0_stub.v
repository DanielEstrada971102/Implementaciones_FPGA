...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(reg0_i, reg1_i, reg0_o, reg1_o, reg2_o, axil_aclk, 
...
/* synthesis syn_black_box black_box_pad_pin="reg0_i[7:0],reg1_i[7:0],reg0_o[7:0],reg1_o[7:0],reg2_o[7:0],axil_aclk,axil_aresetn,axil_awaddr[7:0],axil_awprot[2:0],axil_awvalid,axil_awready,axil_wdata[31:0],axil_wstrb[3:0],axil_wvalid,axil_wready,axil_bresp[1:0],axil_bvalid,axil_bready,axil_araddr[7:0],axil_arprot[2:0],axil_arvalid,axil_arready,axil_rdata[31:0],axil_rresp[1:0],axil_rvalid,axil_rready" */;
  input [7:0]reg0_i;
  input [7:0]reg1_i;
  output [7:0]reg0_o;
  output [7:0]reg1_o;
