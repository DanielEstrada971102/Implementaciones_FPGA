...
(* CORE_GENERATION_INFO="trace_cntrl_64,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.873000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=785,HLS_SYN_LUT=1074,HLS_VERSION=2019_1}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_data_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_data_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_data_V_1_vld_in == 1'b1)))) begin
            capture_64_data_V_1_state <= 2'd1;
        end else if (((~((capture_64_data_V_1_vld_in == 1'b0) & (capture_64_data_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_data_V_1_vld_in == 1'b1)) & (capture_64_data_V_1_state == 2'd3)) | ((capture_64_data_V_1_state == 2'd1) & (capture_64_data_V_1_ack_out == 1'b1)) | ((capture_64_data_V_1_state == 2'd2) & (capture_64_data_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_dest_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_dest_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_dest_V_1_vld_in == 1'b1)))) begin
            capture_64_dest_V_1_state <= 2'd1;
        end else if (((~((capture_64_dest_V_1_vld_in == 1'b0) & (capture_64_dest_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_dest_V_1_vld_in == 1'b1)) & (capture_64_dest_V_1_state == 2'd3)) | ((capture_64_dest_V_1_state == 2'd1) & (capture_64_dest_V_1_ack_out == 1'b1)) | ((capture_64_dest_V_1_state == 2'd2) & (capture_64_dest_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_id_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_id_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_id_V_1_vld_in == 1'b1)))) begin
            capture_64_id_V_1_state <= 2'd1;
        end else if (((~((capture_64_id_V_1_vld_in == 1'b0) & (capture_64_id_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_id_V_1_vld_in == 1'b1)) & (capture_64_id_V_1_state == 2'd3)) | ((capture_64_id_V_1_state == 2'd1) & (capture_64_id_V_1_ack_out == 1'b1)) | ((capture_64_id_V_1_state == 2'd2) & (capture_64_id_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_keep_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_keep_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_keep_V_1_vld_in == 1'b1)))) begin
            capture_64_keep_V_1_state <= 2'd1;
        end else if (((~((capture_64_keep_V_1_vld_in == 1'b0) & (capture_64_keep_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_keep_V_1_vld_in == 1'b1)) & (capture_64_keep_V_1_state == 2'd3)) | ((capture_64_keep_V_1_state == 2'd1) & (capture_64_keep_V_1_ack_out == 1'b1)) | ((capture_64_keep_V_1_state == 2'd2) & (capture_64_keep_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_last_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_last_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_last_V_1_vld_in == 1'b1)))) begin
            capture_64_last_V_1_state <= 2'd1;
        end else if (((~((capture_64_last_V_1_vld_in == 1'b0) & (capture_64_last_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_last_V_1_vld_in == 1'b1)) & (capture_64_last_V_1_state == 2'd3)) | ((capture_64_last_V_1_state == 2'd1) & (capture_64_last_V_1_ack_out == 1'b1)) | ((capture_64_last_V_1_state == 2'd2) & (capture_64_last_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_strb_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_strb_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_strb_V_1_vld_in == 1'b1)))) begin
            capture_64_strb_V_1_state <= 2'd1;
        end else if (((~((capture_64_strb_V_1_vld_in == 1'b0) & (capture_64_strb_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_strb_V_1_vld_in == 1'b1)) & (capture_64_strb_V_1_state == 2'd3)) | ((capture_64_strb_V_1_state == 2'd1) & (capture_64_strb_V_1_ack_out == 1'b1)) | ((capture_64_strb_V_1_state == 2'd2) & (capture_64_strb_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((capture_64_user_V_1_state == 2'd1) & (capture_64_TREADY == 1'b0)) | ((capture_64_user_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0) & (capture_64_user_V_1_vld_in == 1'b1)))) begin
            capture_64_user_V_1_state <= 2'd1;
        end else if (((~((capture_64_user_V_1_vld_in == 1'b0) & (capture_64_user_V_1_ack_out == 1'b1)) & ~((capture_64_TREADY == 1'b0) & (capture_64_user_V_1_vld_in == 1'b1)) & (capture_64_user_V_1_state == 2'd3)) | ((capture_64_user_V_1_state == 2'd1) & (capture_64_user_V_1_ack_out == 1'b1)) | ((capture_64_user_V_1_state == 2'd2) & (capture_64_user_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln20_fu_182_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln20_reg_286 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln23_fu_225_p2 == 1'd1) & (icmp_ln20_fu_182_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln20_fu_182_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln23_fu_225_p2 == 1'd1) & (icmp_ln20_fu_182_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((~((capture_64_dest_V_1_state == 2'd1) | (capture_64_id_V_1_state == 2'd1) | (capture_64_last_V_1_state == 2'd1) | (capture_64_user_V_1_state == 2'd1) | (capture_64_strb_V_1_state == 2'd1) | (capture_64_keep_V_1_state == 2'd1) | (capture_64_data_V_1_state == 2'd1) | ((capture_64_dest_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_id_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_last_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_user_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_strb_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_keep_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_data_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0))) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln20_reg_286 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (or_ln23_reg_320_pp0_iter1_reg == 1'd1) & (icmp_ln20_reg_286_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (or_ln23_reg_320 == 1'd1) & (icmp_ln20_reg_286 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln20_fu_182_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln20_fu_182_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln20_fu_182_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln20_fu_182_p2 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln20_fu_182_p2 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln20_fu_182_p2 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((icmp_ln20_fu_182_p2 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0));
end
...
always @ (*) begin
    ap_block_state5 = ((capture_64_dest_V_1_state == 2'd1) | (capture_64_id_V_1_state == 2'd1) | (capture_64_last_V_1_state == 2'd1) | (capture_64_user_V_1_state == 2'd1) | (capture_64_strb_V_1_state == 2'd1) | (capture_64_keep_V_1_state == 2'd1) | (capture_64_data_V_1_state == 2'd1) | ((capture_64_dest_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_id_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_last_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_user_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_strb_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_keep_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)) | ((capture_64_data_V_1_state == 2'd3) & (capture_64_TREADY == 1'b0)));
end

always @ (*) begin
    ap_condition_852 = ((1'b0 == ap_block_pp0_stage0) & (icmp_ln20_fu_182_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign trunc_ln555_1_fu_211_p1 = trace_64_data_V_0_data_out[31:0];
