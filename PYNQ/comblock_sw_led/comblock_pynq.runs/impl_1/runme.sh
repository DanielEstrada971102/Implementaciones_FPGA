...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/PYNQ_comblock/comblock_pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comblock_desing_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comblock_desing_wrapper.tcl -notrace
