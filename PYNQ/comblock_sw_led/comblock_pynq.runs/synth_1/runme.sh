...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/PYNQ/PYNQ_comblock/comblock_pynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comblock_desing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comblock_desing_wrapper.tcl
