...
################################################################
# This is a generated script based on design: led_control_desing
#
...
# source led_control_desing_script.tcl
...
set design_name led_control_desing
...
proc create_root_design { parentCell } {
  ...
  # Create instance: board_leds_4b, and set properties
  set board_leds_4b [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 board_leds_4b ]
  ...
  # Create instance: board_sw_2b, and set properties
  set board_sw_2b [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 board_sw_2b ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net board_leds_4b_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins board_leds_4b/GPIO]
  connect_bd_intf_net -intf_net board_sw_2b_GPIO [get_bd_intf_ports sws_2bits] [get_bd_intf_pins board_sw_2b/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins board_leds_4b/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins board_sw_2b/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins board_leds_4b/s_axi_aclk] [get_bd_pins board_sw_2b/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins board_leds_4b/s_axi_aresetn] [get_bd_pins board_sw_2b/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs board_leds_4b/S_AXI/Reg] SEG_board_leds_4b_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs board_sw_2b/S_AXI/Reg] SEG_board_sw_2b_Reg
