...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/custom_IP2/custom_IP2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log customIp2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source customIp2_wrapper.tcl -notrace
