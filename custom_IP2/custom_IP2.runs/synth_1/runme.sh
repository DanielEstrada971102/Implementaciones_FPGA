...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/custom_IP2/custom_IP2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log customIp2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source customIp2_wrapper.tcl
