...
HD_PWD='C:/Users/danie/Documents/Lab3_FPGA_codes/System_etapa1_V2/System_etapa1_V2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S1_Reception.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S1_Reception.tcl
