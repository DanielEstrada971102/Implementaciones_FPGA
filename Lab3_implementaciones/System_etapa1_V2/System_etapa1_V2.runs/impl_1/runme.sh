...
HD_PWD='C:/Users/danie/Documents/Lab3_FPGA_codes/System_etapa1_V2/System_etapa1_V2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S1_Reception.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S1_Reception.tcl -notrace
