...
--tamaño puede ser modificado en N_bits, 
--de este mismo tamaño es el string enviado.
--se tiene dos señales de sincrinizacion para cada modulo 
...
signal count_bits_tx : Integer := (N_bits-1); --señal interna
...
signal count_bits_rx : Integer := (N_bits-1); --señal interna
