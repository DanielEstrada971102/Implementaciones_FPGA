...
set_property -dict { PACKAGE_PIN M19    IOSTANDARD LVCMOS33 } [get_ports { enb }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { outputDate }]; #IO_L6P_T0_34 Sch=LED1
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { outputDate }]; #IO_L17P_T2_34 Sch=JA1_P
...
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { TXD_IN }]; #IO_L12P_T1_MRCC_34 Sch=JA3_P
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { ja_n[3] }]; #IO_L12N_T1_MRCC_34 Sch=JA3_N
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { RXD_OUT }]; #IO_L22P_T3_34 Sch=JA4_P
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { RXD_OUT  }]; #IO_L5P_T0_34            Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { TXD_IN  }]; #IO_L2N_T0_34            Sch=CK_IO1
