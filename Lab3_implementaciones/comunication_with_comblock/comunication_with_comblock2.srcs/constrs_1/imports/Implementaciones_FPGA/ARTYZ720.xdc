...
#set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { done }]; #IO_L6P_T0_34 Sch=LED1
...
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { pmod_outdate }]; #IO_L17N_T2_34 Sch=JA1_N
...
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L12P_T1_MRCC_34 Sch=JA3_P
...
set_property PULLDOWN true [get_ports pmod_RXD_IN]
set_property PULLDOWN true [get_ports pmod_TXD_OUT]
set_property PULLDOWN true [get_ports clk_led_out]
