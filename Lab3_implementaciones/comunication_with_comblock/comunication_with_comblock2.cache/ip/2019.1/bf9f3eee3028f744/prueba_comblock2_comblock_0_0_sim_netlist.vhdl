...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  ...
  attribute SOFT_HLUTNM of \regs_out[2][7]_i_1\ : label is "soft_lutpair0";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ComBlock is
  port (
    \regs_out_reg[2][7]_0\ : out STD_LOGIC;
    reg2_o : out STD_LOGIC_VECTOR ( 7 downto 0 );
    reg1_o : out STD_LOGIC_VECTOR ( 7 downto 0 );
    reg0_o : out STD_LOGIC_VECTOR ( 7 downto 0 );
    \regs_out_reg[2][6]_0\ : out STD_LOGIC;
    \regs_out_reg[2][5]_0\ : out STD_LOGIC;
    \regs_out_reg[2][4]_0\ : out STD_LOGIC;
    \regs_out_reg[2][3]_0\ : out STD_LOGIC;
    \regs_out_reg[2][2]_0\ : out STD_LOGIC;
    \regs_out_reg[2][1]_0\ : out STD_LOGIC;
    \regs_out_reg[2][0]_0\ : out STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
    E : in STD_LOGIC_VECTOR ( 0 to 0 );
    axil_wdata : in STD_LOGIC_VECTOR ( 7 downto 0 );
    axil_aclk : in STD_LOGIC;
    \regs_out_reg[1][7]_0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \regs_out_reg[2][7]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
AXIL_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL
     port map (
      ...
      \axi_awaddr_reg[6]_1\(0) => AXIL_inst_n_17,
...
comblock_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ComBlock
     port map (
      ...
      \regs_out_reg[2][0]_0\ => comblock_i_n_31,
      \regs_out_reg[2][1]_0\ => comblock_i_n_30,
      \regs_out_reg[2][2]_0\ => comblock_i_n_29,
      \regs_out_reg[2][3]_0\ => comblock_i_n_28,
      \regs_out_reg[2][4]_0\ => comblock_i_n_27,
      \regs_out_reg[2][5]_0\ => comblock_i_n_26,
      \regs_out_reg[2][6]_0\ => comblock_i_n_25,
      \regs_out_reg[2][7]_0\ => comblock_i_n_0,
      \regs_out_reg[2][7]_1\(0) => \regs_out[2]_1\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
