...
HD_PWD='C:/Users/danie/Documents/Lab3_FPGA_codes/System_etapa1/System_etapa1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S1_transmission.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S1_transmission.tcl -notrace
