...
HD_PWD='C:/Users/danie/Documents/Lab3_FPGA_codes/System_etapa1/System_etapa1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S1_transmission.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S1_transmission.tcl
