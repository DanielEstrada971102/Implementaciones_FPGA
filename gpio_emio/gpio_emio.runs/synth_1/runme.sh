...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/gpio_emio/gpio_emio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log emio_desing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source emio_desing_wrapper.tcl
