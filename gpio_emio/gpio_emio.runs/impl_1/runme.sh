...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/gpio_emio/gpio_emio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log emio_desing_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source emio_desing_wrapper.tcl -notrace
