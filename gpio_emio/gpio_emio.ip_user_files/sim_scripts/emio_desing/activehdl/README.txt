...
#
# Generated by export_simulation on Sat Mar 14 22:42:33 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './emio_desing.sh' script.

./emio_desing.sh -reset_run
...
./emio_desing.sh -noclean_files

For more information on the script, please type './emio_desing.sh -help'.
