...
## Switches
#set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { freq_select[0] }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
## LEDs
#set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { led_out }]; #IO_L6N_T0_VREF_34 Sch=LED0
...
## Buttons
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports {BTNR_tri_io }]; #IO_L4P_T0_35 Sch=BTN0
...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { Signal_out }]; #IO_L17P_T2_34 Sch=JA1_P
