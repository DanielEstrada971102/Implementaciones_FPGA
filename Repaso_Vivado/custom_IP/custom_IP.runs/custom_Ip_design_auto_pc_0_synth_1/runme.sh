...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/custom_IP/custom_IP.runs/custom_Ip_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_Ip_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_Ip_design_auto_pc_0.tcl
