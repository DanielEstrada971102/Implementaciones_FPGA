...
HD_PWD='C:/Users/danie/Documents/Implementaciones_FPGA/Repaso_Vivado/Gpio/Gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_control_desing_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_control_desing_wrapper.tcl -notrace
