...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/Gpio/Gpio.runs/led_control_desing_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_control_desing_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_control_desing_axi_gpio_0_0.tcl
