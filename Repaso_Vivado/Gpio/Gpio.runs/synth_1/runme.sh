...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/Gpio/Gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_control_desing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_control_desing_wrapper.tcl
