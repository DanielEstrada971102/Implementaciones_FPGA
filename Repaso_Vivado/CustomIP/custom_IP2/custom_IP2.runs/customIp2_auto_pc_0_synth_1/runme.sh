...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/custom_IP2/custom_IP2.runs/customIp2_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log customIp2_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source customIp2_auto_pc_0.tcl
