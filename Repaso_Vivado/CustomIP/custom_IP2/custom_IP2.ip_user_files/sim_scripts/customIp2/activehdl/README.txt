...
#
# Generated by export_simulation on Mon Mar 16 01:21:17 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './customIp2.sh' script.

./customIp2.sh -reset_run
...
./customIp2.sh -noclean_files

For more information on the script, please type './customIp2.sh -help'.
