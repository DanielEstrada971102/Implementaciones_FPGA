...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/custom_IP/custom_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_Ip_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source custom_Ip_design_wrapper.tcl -notrace
