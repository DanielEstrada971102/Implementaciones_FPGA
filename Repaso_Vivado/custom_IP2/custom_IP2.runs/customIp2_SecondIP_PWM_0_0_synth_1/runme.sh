...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/custom_IP2/custom_IP2.runs/customIp2_SecondIP_PWM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log customIp2_SecondIP_PWM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source customIp2_SecondIP_PWM_0_0.tcl
