...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/HelloWorld/HelloWorld.runs/Only_processor_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Only_processor_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Only_processor_processing_system7_0_0.tcl
