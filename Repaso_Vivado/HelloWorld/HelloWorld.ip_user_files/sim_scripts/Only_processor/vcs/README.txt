...
#
# Generated by export_simulation on Fri Feb 28 22:50:17 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './Only_processor.sh' script.

./Only_processor.sh -reset_run
...
./Only_processor.sh -noclean_files

For more information on the script, please type './Only_processor.sh -help'.
