...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/PYNQ_comblock/comblock_pynq.runs/comblock_desing_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comblock_desing_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comblock_desing_xbar_0.tcl
