...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/IP_custom2/managed_ip_project/managed_ip_project.runs/SecondIP_PWM_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SecondIP_PWM_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SecondIP_PWM_0.tcl
