...
#
# Generated by export_simulation on Mon Mar 16 16:41:14 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './SecondIP_PWM_0.sh' script.

./SecondIP_PWM_0.sh -reset_run
...
./SecondIP_PWM_0.sh -noclean_files

For more information on the script, please type './SecondIP_PWM_0.sh -help'.
