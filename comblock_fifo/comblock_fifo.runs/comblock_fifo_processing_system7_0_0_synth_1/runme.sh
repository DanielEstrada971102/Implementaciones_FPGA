...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/comblock_fifo/comblock_fifo.runs/comblock_fifo_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comblock_fifo_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comblock_fifo_processing_system7_0_0.tcl
