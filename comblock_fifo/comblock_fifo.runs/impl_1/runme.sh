...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/comblock_fifo/comblock_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comblock_fifo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comblock_fifo_wrapper.tcl -notrace
