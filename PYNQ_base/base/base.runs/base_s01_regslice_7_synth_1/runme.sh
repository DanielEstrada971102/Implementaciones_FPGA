...
HD_PWD='C:/Users/danie/Documents/Repaso_VIVADO/PYNQ_base/base/base.runs/base_s01_regslice_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_s01_regslice_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_s01_regslice_7.tcl
