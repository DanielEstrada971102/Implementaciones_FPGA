...
(* CORE_GENERATION_INFO="pixel_unpack,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.302000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=394,HLS_SYN_LUT=652,HLS_VERSION=2019_1}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((stream_out_24_data_V_1_state == 2'd1) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_data_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0) & (stream_out_24_data_V_1_vld_in == 1'b1)))) begin
            stream_out_24_data_V_1_state <= 2'd1;
        end else if (((~((stream_out_24_data_V_1_vld_in == 1'b0) & (stream_out_24_data_V_1_ack_out == 1'b1)) & ~((stream_out_24_TREADY == 1'b0) & (stream_out_24_data_V_1_vld_in == 1'b1)) & (stream_out_24_data_V_1_state == 2'd3)) | ((stream_out_24_data_V_1_state == 2'd1) & (stream_out_24_data_V_1_ack_out == 1'b1)) | ((stream_out_24_data_V_1_state == 2'd2) & (stream_out_24_data_V_1_vld_in == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | (~((stream_out_24_last_V_1_state == 2'd1) | (stream_out_24_user_V_1_state == 2'd1) | (stream_out_24_data_V_1_state == 2'd1) | ((stream_out_24_last_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_user_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_data_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0))) & (1'b1 == ap_CS_fsm_state27)))) begin
        mode_0_ack_out = 1'b1;
    end else begin
        mode_0_ack_out = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp4_stage1_01001) & (ap_enable_reg_pp4_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp4_stage1))) begin
        stream_out_24_last_V_1_data_in = or_ln46_1_reg_465;
    end else if (((1'b0 == ap_block_pp3_stage0_01001) & (ap_enable_reg_pp3_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp3_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp4_stage2_01001) & (1'b1 == ap_CS_fsm_pp4_stage2) & (ap_enable_reg_pp4_iter0 == 1'b1))) begin
        stream_out_24_user_V_1_data_in = or_ln718_1_fu_300_p2;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state27 : begin
            if ((~((stream_out_24_last_V_1_state == 2'd1) | (stream_out_24_user_V_1_state == 2'd1) | (stream_out_24_data_V_1_state == 2'd1) | ((stream_out_24_last_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_user_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_data_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0))) & (1'b1 == ap_CS_fsm_state27))) begin
...
always @ (*) begin
    ap_block_state27 = ((stream_out_24_last_V_1_state == 2'd1) | (stream_out_24_user_V_1_state == 2'd1) | (stream_out_24_data_V_1_state == 2'd1) | ((stream_out_24_last_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_user_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)) | ((stream_out_24_data_V_1_state == 2'd3) & (stream_out_24_TREADY == 1'b0)));
end
...
assign or_ln46_fu_307_p2 = (stream_in_32_last_V_0_data_out | empty_4_reg_449_2);

assign or_ln718_1_fu_300_p2 = (or_ln718_fu_294_p2 | empty_reg_438_1);

assign or_ln718_fu_294_p2 = (stream_in_32_user_V_0_data_out | empty_4_reg_449_1);
...
assign trunc_ln414_fu_199_p1 = stream_in_32_data_V_0_data_out[15:0];

assign trunc_ln647_1_fu_270_p1 = stream_in_32_data_V_0_data_out[15:0];

assign trunc_ln647_2_fu_319_p1 = stream_in_32_data_V_0_data_out[7:0];

assign trunc_ln647_3_fu_261_p1 = stream_in_32_data_V_0_data_out[23:0];

assign trunc_ln647_4_fu_237_p1 = stream_in_32_data_V_0_data_out[7:0];

assign trunc_ln647_5_fu_223_p1 = stream_in_32_data_V_0_data_out[15:0];

assign trunc_ln647_fu_266_p1 = stream_in_32_data_V_0_data_out[23:0];
